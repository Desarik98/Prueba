...
public class IemoisGUI extends JFrame{
   ...
   /**
        ...
        botonAdicionar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev){
                try {
                    ...
                    JOptionPane.showMessageDialog(null,"Digite el numero de semanas","Error",JOptionPane.WARNING_MESSAGE);
                    Registro.registre(e);
                    //System.exit(0);
                }
            }
    ...
    private void  accionAdicionar()throws IEMOISExcepcion,NumberFormatException{
   ...
   public static void main(String args[]) throws IEMOISExcepcion, NumberFormatException
   {
